      ...
      <div class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="mt-2 space-y-2">
                <div class="flex items-center">
                  <input id="web" v-model="formData.projectType" type="radio" value="web"
                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                  <label for="web" class="ml-2 block text-sm text-gray-700">Web Application</label>
                </div>
                <div class="flex items-center">
                  <input id="mobile" v-model="formData.projectType" type="radio" value="mobile"
                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                  <label for="mobile" class="ml-2 block text-sm text-gray-700">Mobile App</label>
                </div>
                <div class="flex items-center">
                  <input id="both" v-model="formData.projectType" type="radio" value="both"
                    class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                  <label for="both" class="ml-2 block text-sm text-gray-700">Web + Mobile</label>
                </div>
              </div>
            </div>

            <div>
              <label for="projectDescription" class="block text-sm font-medium text-gray-700">Project
                Description</label>
              <textarea id="projectDescription" v-model="formData.projectDescription" required rows="4"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                placeholder="Describe your project idea, features, and goals..."></textarea>
            </div>
            ...
            <div>
              <label for="budget" class="block text-sm font-medium text-gray-700">Budget Range (USD)</label>
            ...
            <div>
              <label for="mathChallenge" class="block text-sm font-medium text-gray-700">
                Security Check: What is {{ formattedMathProblem }}
              </label>
              <input id="mathChallenge" v-model="userAnswer" type="number" required
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
